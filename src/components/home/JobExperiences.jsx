            ...
            <VerticalTimeline lineColor="black">
              {jobExperiencesWithIcons.map((experience) => (
                <VerticalTimelineElement
                  ...
                  contentStyle={{ background: experience.themeColor, color: '#fff' }}
                  contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }}
                  date={`${experience.date} || ${experience.duration}`} dateClassName="date-color"
                  iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff', padding: '0', border: 'none' }}
                  icon={
                ...
                >
                  <h3 className="vertical-timeline-element-title">{experience.jobTitle}</h3>
